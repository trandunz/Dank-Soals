            ...
            case "Pistol":
                {
                    ...
                    Rigidbody bullet = Instantiate(m_Player.m_WeaponWheel[0].GetComponent<Script_Weapon>().m_Bullet, m_Player.m_WeaponWheel[1].GetComponent<Script_Weapon>().m_Muzzle.transform.position, m_Player.m_WeaponWheel[1].GetComponent<Script_Weapon>().m_Muzzle.transform.rotation);
